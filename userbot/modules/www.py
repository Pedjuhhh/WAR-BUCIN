...
async def redis(pong):
    ...
    start = datetime.now()
    await pong.edit("__Bismilah.__")
    await pong.edit("__Bismilah..__")
    await pong.edit("__Bismilah...__")
    await pong.edit("__Bismilahh....__")
    await pong.edit("__Sabar.__")
    await pong.edit("__Sabarr..__")
    await pong.edit("__Sabarrr...__")
    await pong.edit("__Yapsss Bisa....__")
    end = datetime.now()
...
async def redis(pong):
    ...
    uptime = await get_readable_time((time.time() - StartTime))
    start = datetime.now()
    await pong.edit("__Connecting Duls Boss.__")
    await pong.edit("__Connecting Duls Boss..__")
    await pong.edit("__Connecting Duls Boss...__")
    ...
    duration = (end - start).microseconds / 1000
    await pong.edit(f"**🛠️卩乇ㄚㄚ - 𝑃 𝑅 𝑂 𝐽 𝐸 𝐶 𝑇 🛠️**\n"
                    f"➾ __Signal__    __:__ "
                    f"`%sms` \n"
                    f"➾ __Uptime__ __:__ "
                    f"`{uptime}` \n" % (duration))
...
async def redis(pong):
    ...
    duration = (end - start).microseconds / 1000
    await pong.edit(f"➥卩乇ㄚㄚ - 𝑃 𝑅 𝑂 𝐽 𝐸 𝐶 𝑇 \n**➣Pinger** : %sms\n**➣Bot Uptime** : {uptime}⚔️" % (duration))
